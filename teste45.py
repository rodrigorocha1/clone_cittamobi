...
icon_base64 = base64.b64encode(
    open(os.getcwd() + "\\assets\\bus_stop.png", "rb").read()).decode("utf-8")
...
with open(os.getcwd() + "\\assets\\bus_stop.png", "rb") as f:
    icon_base64 = base64.b64encode(f.read()).decode("utf-8")

print(
    f'Posição metade: {busca_linhas[0].trajeto.posicoes[metade_da_posicao].latitude}, \
        {busca_linhas[0].trajeto.posicoes[metade_da_posicao].longitude}')
